...
#   - MNQ (Micro NASDAQ100 E-mini) instead of NQ
...
class ORBMNQTopStep(QCAlgorithm):
    """
    Opening Range Breakout (ORB) strategy on MNQ Micro NASDAQ-100 E-mini futures.
    Adapted for TopStep $50K Combine compliance with:
    - Dynamic position sizing based on trailing drawdown cushion
    - Monthly profit lock at $3,000
    - Conservative buffer ($200) before trailing drawdown level
    Long-only with 200-day EMA trend filter, one trade per day.
    """
    ...
    def Initialize(self):
        ...
        self.MAX_STOP_POINTS  = 50          # 50 pts = max loss per contract
    ...
    def OnOrderEvent(self, orderEvent):
        ...
        if (orderEvent.Direction == OrderDirection.Buy
            ...
            # Stop: ORB Low, capped at 50 pts below fill
            stop = self.orb_low
